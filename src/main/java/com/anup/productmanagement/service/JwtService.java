...
public class JwtService {
    ...
    private String buildToken(HashMap<String, Object> claims, UserDetails userDetails, Long jwtExpiry) {
    ...
    public <T> T extractClaim(String jwtToken, Function<Claims, T> claimeResolver) {
